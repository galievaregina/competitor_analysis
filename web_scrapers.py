...
def load_hetzner(url):
    ...
    data_hetzner.to_csv(r'C:\Users\galieva.r\PycharmProjects\competitors_analyzing\hetzner{current_date}.csv',
                        index=False)
...
def load_servers_ru(url):
    ...
    data_servers_ru = data_servers_ru.astype(
        {'id': int, 'cpu_name': str, 'cpu_count': int, 'gpu_count': str, 'cores': int, 'frequency': float, 'ram': int,
         ...
         'datacenter': str})
    data_servers_ru.to_csv(r'C:\Users\galieva.r\PycharmProjects\competitors_analyzing\servers_ru{current_date}.csv',
                           index=False)
...
if __name__ == '__main__':
    url_hetzner = 'https://www.hetzner.com/_resources/app/jsondata/live_data_en.json?m=1668497923041'
